...
namespace HindiBackApp.Controllers
{
    ...
    public class ApplicationUserController : ControllerBase
    {
        ...
        public ApplicationUserController(UserManager<Models.ApplicationUser> userManager, SignInManager<HindiBackApp.Models.ApplicationUser> signInManager, IOptions<ApplicationSettings> appSettings)
        {
